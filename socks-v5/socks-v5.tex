...
\begin{document}
  ...
  \begin{frame}{Überblick}
    \begin{itemize}
      ...
      \item Änderungen von SOCKSv4 zu SOCKSv5
      \item Ausblick
      \item Beispiel
    \end{itemize}
  \end{frame}
  ...
  \begin{frame}{Ablauf: SOCKSv5 mit TCP-Client}
    \begin{itemize}
      \item
  ...
  \begin{frame}{Ablauf: SOCKSv5 mit TCP-Client}
    ...
    \end{itemize}
  \end{frame}
  \begin{frame}{Ablauf: SOCKSv5 mit UDP-Client}
    \begin{itemize}
      \item
       Client sendet UDP Datagram mit folgendem Header: \\ 
       \begin{adjustbox}{max width=\textwidth}
         \begin{tabular}{|c|c|c|c|c|c|}
          \hline
      ...
      \end{adjustbox}
      \item
      Server entweder verwirft Anfrage und sendet nichts zurück oder sendet das entsprechendes Datagram zurück. \\
